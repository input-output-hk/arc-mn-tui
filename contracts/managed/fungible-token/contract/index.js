...
class _Either_0 {
  alignment() {
    return _descriptor_6.alignment().concat(_descriptor_2.alignment().concat(_descriptor_7.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_6.toValue(value_0.is_left).concat(_descriptor_2.toValue(value_0.left).concat(_descriptor_7.toValue(value_0.right)));
  }
}
...
class _Either_2 {
  alignment() {
    return _descriptor_6.alignment().concat(_descriptor_7.alignment().concat(_descriptor_10.alignment()));
  }
  fromValue(value_0) {
    return {
      is_left: _descriptor_6.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_6.toValue(value_0.is_left).concat(_descriptor_7.toValue(value_0.left).concat(_descriptor_10.toValue(value_0.right)));
  }
}
...
class _CoinPreimage_0 {
  alignment() {
    return _descriptor_12.alignment().concat(_descriptor_5.alignment().concat(_descriptor_6.alignment().concat(_descriptor_1.alignment())));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_12.toValue(value_0.domain_sep).concat(_descriptor_5.toValue(value_0.info).concat(_descriptor_6.toValue(value_0.dataType).concat(_descriptor_1.toValue(value_0.data))));
  }
}
...
export class Contract {
      ...
      mint_unshielded: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('mint_unshielded',
                                     'argument 1 (as invoked from Typescript)',
                                     'fungible-token.compact line 72 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(amount_0) === 'bigint' && amount_0 >= 0n && amount_0 <= 18446744073709551615n)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(amount_0).concat(_descriptor_1.toValue(token_id_bytes_0).concat(_descriptor_1.toValue(recipient_0))),
                     ...
                     recipient_0)
  {
    const disclosed_amount_0 = amount_0;
    const disclosed_token_id_0 = token_id_bytes_0;
    const disclosed_recipient_0 = recipient_0;
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('fungible-token.compact line 76 char 20: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('fungible-token.compact line 77 char 20: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(tmp_1),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const user_addr_0 = this._right_0({ bytes: disclosed_recipient_0 });
